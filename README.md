...
Note that I don't react of any changes of the slider right away but only when the sliders are let gone. That way only the final changes of the values will be communicated.
