...
With all these information I was able to realize a first sketch and an app – and got into trouble or let's say had to enter the next level in embedded programming: Dealing with the hardware. I simply transmitted right away the colour values that I generated with sliders in my app and soon the Arduino and the app got stuck.  
