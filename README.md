...
Insbesondere, wenn ich die Farb-Slider in der App so programmiere, dass sie permanent die Änderung der Werte übertragen. Als Lösung übetrage ich jetzt erst dann die Farbwerte, wenn die Slider losgelassen werden.
