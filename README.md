...
If the app sees the transmit char (10), also time triggered (9), it sends the 4 char data '<XY>' (11) and wait aigan for the acknowledge of the Arduino. Because the sketch knows at this time that it awaits data it looks time triggered (12) for the start sign (13).
